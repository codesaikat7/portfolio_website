...
const Contact = () => {
  ...
  const contactInfo = [
    {
      ...
      title: 'Email',
      value: 'code.saikat7@gmail.com',
      link: 'mailto:code.saikat7@gmail.com'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      url: 'https://www.instagram.com/codewithsaikat/',
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    viewport={{ once: true }}
                    className={`p-3 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg transition-all duration-200 ${social.color}`}
                  >
                    {social.icon}
                  </motion.a>
                ))}
